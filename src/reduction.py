...
def manual_selection (region):
	...
	all_7 = merge_dict ([face, head_pose_r, head_pose_t])
	all_8 = merge_dict ([eyetracking, AUrs])
	all_9 = merge_dict ([head_pose_r, head_pose_t, AUrs])
	...
	if region in ["region_1"]:
		set_of_behavioral_predictors = [face, all_1, all_3, all_4, all_5, all_6, all_7, all_8, all_9, all_10]
		...
		set_of_behavioral_predictors = [audio, audio_left, speech_left_ipu, speech_ipu, speech_talk, speech_left_talk, merge_dict ([speech_ipu, speech_left_ipu]),
										merge_dict ([speech_ipu, speech_talk]),  merge_dict ([speech_left_ipu, speech_left_talk])]

	elif region in ["region_4", "region_5"]:
