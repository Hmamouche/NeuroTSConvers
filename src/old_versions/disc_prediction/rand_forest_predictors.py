...
if __name__=='__main__':
	...
	if args.pred_type:
		...
		filename_hh = "results/sub-%02d/disc_all/predictions_randF_Preds_HH.txt"%args.subject
		filename_hr = "results/sub-%02d/disc_all/predictions_randF_Preds_HR.txt"%args.subject
		...
		filename_hh = "results/sub-%02d/disc/predictions_randF_Preds_HH.txt"%args.subject
		filename_hr = "results/sub-%02d/disc/predictions_randF_Preds_HR.txt"%args.subject
