...
if __name__=='__main__':
	...
	filename_hh = "results/sub-%02d/disc_univariate/predictions_randF_HH.txt"%args.subject
	filename_hr = "results/sub-%02d/disc_univariate/predictions_randF_HR.txt"%args.subject
		...
		for  external_predictors in  behavioral_predictors:
			...
			for lag in range (1, args.lag + 1):
				...
				while (i < len (convers_order)):
					...
					# test data : two first conversations
